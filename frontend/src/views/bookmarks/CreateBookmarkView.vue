<template>
    <div class="container mx-auto px-4 py-6">
        ...
        <!-- IMPORTANT NOTICE -->
        <div class="mb-6 p-4 rounded bg-yellow-100 border-l-4 border-yellow-500 text-yellow-900 dark:bg-yellow-900 dark:text-yellow-100 dark:border-yellow-400">
            ...
            <br>
            <span class="block mt-2 text-sm text-gray-700 dark:text-gray-300">If you need to inspect the page for a thumbnail manually: <br>
